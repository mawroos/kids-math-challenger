...
const SetupScreen: React.FC<SetupScreenProps> = ({ onStartQuiz, onStartWritingChallenge, onLoadSession }) => {
  ...
  const loadSamoNovaPreset = () => {
    loadPreset('https://mawroos.github.io/kids-math-challenger/?q=z0l_O_a_k_b_k_b_b_a_cLs_Aa3_cLs_Aa3_b_cLs_Aa3_cLs_Aa3_c_f_E_u_bH_k_k_Y_k_Y_p_qi_Aa3_b_c_q_k_Aa3_b_d_b_p_k');
  };
